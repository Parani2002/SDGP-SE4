...
results00 = s.find('ul',class_='inner-dept-courses')
...
#details
        ...
        details = s.find_all('span',class_='elementor-headline-dynamic-text elementor-headline-text-active')
...
#Writing
        ...
        Write=[degreeName[0].text,"Science","Pitipana - Thalagala Rd, Homagama","Degree",details1[0]+" "+details1[1],degreeNameAff,degreeLink[x]]
        print(Write)        
...
#Writing
        ...
        Write=[degreeName[0].text,"Science","Pitipana - Thalagala Rd, Homagama","Foundation",details1[0]+" "+details1[1],degreeNameAff,foundationLink[x]]
        print(Write)        
