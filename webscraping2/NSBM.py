...
results00 = s.find('div',class_='inner-dept-wrap')
...
#Writing
        ...
        Write=[degreeName[0].text,"Computing","Pitipana - Thalagala Rd, Homagama","Degree",details1[0]+" "+details1[1],degreeNameAff,degreeLink[x]]
        print(Write)        
