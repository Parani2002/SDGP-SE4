...
# Find the correct div containing the degree links
results00 = s.find('div', class_='row course-listing')
...
if results00:
    ...
    with open('NSBM_Computing.csv', 'w', newline='') as file:
        ...
        for x in range(0, len(degreeLink)):
            ...
            # Writing
            Write = [degreeName[0].text, "Computing", "Pitipana - Thalagala Rd, Homagama", "Degree", Year,
                     details1[0] + " " + details1[1], degreeNameAff, degreeLink[x]]
            print(Write)
