...
#details
        ...
        if(len(duration1)==3):
            ...
            Write=[degreeName.text,"Computing","57 Ramakrishna Rd, Colombo 00600","Foundation",duration1[1]+" "+duration1[1],"Informatics Institute of Technology",foundationLink[x]]
