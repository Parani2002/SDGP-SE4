...
# Extract links for different types of programmes
try:
...
degreeLinkArray = []
try:
    # Iterate over each type of programme and extract links
    for link in degree:
...
with open('school_of_business.csv', 'w', newline='') as file:
